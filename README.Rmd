...
`r latexImg('H_{obs}')` is calculated by using ordinary kriging together with the observed irradiation from all the official stations. The function `kriging()`, which is included in this package, performs the ordinary kriging and returns a raster dataset with interpolated values.
